...
use Rollerworks\Component\Metadata\Driver\SingleBaseFileLocator;
use Rollerworks\Component\Metadata\Tests\MetadataTestCase;

class SingleBaseFileLocatorTest extends MetadataTestCase
{
    /**
     * @test
     */
    ...
    {
        $locator = new SingleBaseFileLocator('\\', dirname(__DIR__).'/_files', '.yml');
    ...
    public function it_finds_mapping_files_without_prefix()
    {
        ...
        $locator = new SingleBaseFileLocator('\\', $path, '.yml');
    ...
    public function it_finds_mapping_files_with_prefix()
    {
        ...
        $locator = new SingleBaseFileLocator('Acme\\', $path, '.yml');
    ...
    // The prefix of class "stdClass" does not match with the configured prefix: Acme
    ...
    public function it_only_finds_all_mapped_classes_with_file_extension()
    {
        ...
        $locator = new SingleBaseFileLocator('\\', $path, '.xml');
